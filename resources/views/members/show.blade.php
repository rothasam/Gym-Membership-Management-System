                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="text-info me-2 {{ request()->routeIs('members.detail') ? 'active' : '' }}" href="{{ route('members.detail') }}" title="Preview"><i class="fas fa-eye"></i></a>
                    ...
                    <tr>
                        ...
                        <td>2025-05-21</td>
                        <td class="text-center">
                            <a class="text-info me-2 {{ request()->routeIs('members.register') ? 'active' : '' }}" href="{{ route('members.detail') }}" title="detail"><i class="fas fa-eye"></i></a>
