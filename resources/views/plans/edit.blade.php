        ...
        <div class="col-md-6">
            <div class="card shadow-sm" style="background-color: rgba(255, 255, 255, 0.62);">
                <div class="card-header text-white" style="background-color: rgb(240, 14, 101);">
                    <h5 class="mb-0">Edit Membership Plan</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('plans.update', $plan->membership_plan_id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="duration_month" name="duration_month" 
                                   value="{{ old('duration_month', $plan->duration_month) }}" placeholder="e.g. 1, 3, 6" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="total_class" name="total_class" 
                                   value="{{ old('total_class', $plan->total_class) }}" placeholder="e.g. 20">
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <a href="{{ route('plans.index') }}" class="btn btn-secondary px-4">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
